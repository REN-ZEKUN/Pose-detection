...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 19 17:17:13 2021
...
IP = '192.168.137.71' #视频接受端的IP地址, ip of PC
...
for frame in camera.capture_continuous(rawCapture, format='bgr', use_video_port=True):
    ...
    encoded, buffer = cv2.imencode('.jpg', frame_image) #把转换后的图像数据再次转换成流数据，并且把流数据储存到内存buffer中
